package com.dudu.workflow.push.ping;
 ...
 */
public class PingFrameBuilder extends FramedataImpl1 implements PingFrame {
    ...
    public PingFrameBuilder() {
        super(Opcode.PING);
        setFin(true);
    }

    public PingFrameBuilder(int code) throws InvalidDataException {
        super(Opcode.PING);
        setFin(true);
        setCodeAndMessage(code, "");
    }

    public PingFrameBuilder(int code, String m) throws InvalidDataException {
        super(Opcode.PING);
        setFin(true);
