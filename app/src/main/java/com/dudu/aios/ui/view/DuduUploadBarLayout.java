...
public class DuduUploadBarLayout extends RelativeLayout {
    ...
    public static final int STATE_FAILD = 3;//上传失败
    ...
    private void init() {
        ...
        if (TextUtils.isEmpty(faileText)) {
            faileText = "上传失败";
        }
    ...
    public void setFaile(boolean faile) {
        isFaile = faile;
        mFailTextView.setVisibility(isFaile ? View.VISIBLE : View.INVISIBLE);
    }
    ...
    private ViewGroup makeNormalLayout() {
        ...
        mFailTextView = new TextView(getContext());
        mFailTextView.setText(faileText);
        mFailTextView.setLayoutParams(new LinearLayout.LayoutParams(0, -1, 1));
        mFailTextView.setTextColor(Color.WHITE);
        mFailTextView.setPadding(10, 0, 10, 0);
        mFailTextView.setGravity(Gravity.CENTER);
        mFailTextView.setVisibility(View.INVISIBLE);
        ...
        linearLayout.setOrientation(LinearLayout.HORIZONTAL);
        linearLayout.addView(mFailTextView);
    ...
    private ViewGroup makeFaileLayout() {
        LinearLayout linearLayout = new LinearLayout(getContext());
        linearLayout.setGravity(Gravity.CENTER);
        linearLayout.setLayoutParams(makeLayoutParams());
        linearLayout.setOrientation(LinearLayout.HORIZONTAL);
    ...
    @IntDef({STATE_NORMAL, STATE_UPING, STATE_FINISH, STATE_FAILD})
