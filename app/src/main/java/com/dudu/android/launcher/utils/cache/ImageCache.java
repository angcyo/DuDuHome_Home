 ...
 * {@link ImageCache#getInstance(android.support.v4.app.FragmentManager, ImageCacheParams)} to getDefaultConfig an instance of this
...
public class ImageCache {
     ...
     *
     * @param data Unique identifier for which item to getDefaultConfig
